...
Each task lists files, interfaces, then checkbox steps: write failing test, watch it fail, write minimal code, watch it pass, commit. No placeholders. No "similar to Task N". No "add appropriate error handling" without the actual code.
