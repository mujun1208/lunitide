...
func TestWeatherFetcherIdentifiesOnlyConfiguredMETEndpoint(t *testing.T) {
	...
	if err != nil || !strings.Contains(options.UserAgent, "Lunitide/"+buildinfo.Version) || !strings.Contains(options.UserAgent, "114921798@qq.com") || options.IfModifiedSince != modified || options.Policy.AllowHTTP || options.Proxy == nil {
