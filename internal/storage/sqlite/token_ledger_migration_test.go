...
DROP TABLE office_storage_sweep_items;
DROP TABLE office_storage_sweeps;
DROP TABLE office_blob_events;
DROP TABLE office_blob_references;
...
DROP TABLE office_step_receipts;
DROP TABLE office_validation_runs;
DROP TABLE artifact_lifecycle_events;
DROP TABLE office_artifact_heads;
DROP TABLE office_version_metadata;
DROP TABLE office_task_artifacts;
DROP TABLE office_tasks;
...
DROP TABLE IF EXISTS protocol_private;
DROP TABLE IF EXISTS protocol_message_groups;
DROP TABLE IF EXISTS model_fit_qualification;
DROP TABLE IF EXISTS agent_hub_artifacts;
DROP TABLE IF EXISTS agent_hub_events;
DROP TABLE IF EXISTS agent_hub_tasks;
DROP TABLE IF EXISTS agent_hub_messages;
DROP TABLE IF EXISTS agent_hub_thread_events;
DROP TABLE IF EXISTS agent_hub_thread_files;
DROP TABLE IF EXISTS agent_hub_prompts;
DROP TABLE IF EXISTS agent_hub_threads;
DROP TABLE IF EXISTS model_call_attempts;
...
DROP TABLE IF EXISTS product_apply_log;
DROP TABLE IF EXISTS product_diagnostic_findings;
DROP TABLE IF EXISTS product_diagnostic_reports;
DROP TABLE IF EXISTS product_change_log;
DROP TABLE IF EXISTS product_node_tags;
DROP TABLE IF EXISTS product_tags;
DROP TABLE IF EXISTS product_enrichments;
DROP TABLE IF EXISTS product_graph_index_versions;
DROP TABLE IF EXISTS product_chain_steps;
DROP TABLE IF EXISTS product_feature_cards;
DROP TABLE IF EXISTS product_graph_edges;
DROP TABLE IF EXISTS product_graph_nodes;
DROP TABLE IF EXISTS product_snapshots;
DROP TABLE IF EXISTS product_hub_auth;
