...
func TestParallelToolEligible(t *testing.T) {
	...
	mutating := []string{"workspace.write", "workspace.edit", "command.run", "todo.write", "excel.gen", "docx.gen", "pptx.gen", "pdf.gen", "html.gen", "desktop.open", "desktop.type", "cc.mouse_click", "cc.keyboard_type", "subagent.spawn", "plan.run", "unknown.tool"}
