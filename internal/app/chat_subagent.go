...
func readOnlyEngineToolDefinitions() []gateway.ToolDefinition {
	...
	for _, d := range all {
		if d.Name == "workspace.write" || d.Name == "workspace.edit" || d.Name == "html.gen" || d.Name == "desktop.open" || d.Name == "desktop.type" || d.Name == "media.play" || d.Name == "browser.act" || d.Name == "image.generate" || d.Name == "video.generate" || d.Name == toolStructuredOutput || d.Name == "user.ask" {
			continue
		}
		out = append(out, d)
	}
