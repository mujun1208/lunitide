...
func (s *Service) UpsertComponent(ctx context.Context, sn, pn string, life float64) (Component, error) {
	return atomicValue(s, ctx, func(ctx context.Context) (Component, error) {
		ops, err := s.ops()
		if err != nil {
...
func (s *Service) ListGenealogies(ctx context.Context) ([]GenealogyView, error) {
	return atomicValue(s, ctx, func(ctx context.Context) ([]GenealogyView, error) {
		ops, err := s.ops()
		if err != nil {
			return nil, err
		}
...
func (s *Service) DraftPirep(ctx context.Context, tailNo, bodyJSON string) (PirepDraft, error) {
	return atomicValue(s, ctx, func(ctx context.Context) (PirepDraft, error) {
		ops, err := s.ops()
		if err != nil {
...
func (s *Service) IntakeAOG(ctx context.Context, text string) (AOGCase, error) {
	return atomicValue(s, ctx, func(ctx context.Context) (AOGCase, error) {
		ops, err := s.ops()
		if err != nil {
			return AOGCase{}, err
		}
...
func (s *Service) DraftPO(ctx context.Context, pn, qty, price string) (PODraft, error) {
	return atomicValue(s, ctx, func(ctx context.Context) (PODraft, error) {
		ops, err := s.ops()
		if err != nil {
			return PODraft{}, err
		}
...
func (s *Service) Triggers(ctx context.Context) ([]TriggerRow, error) {
	return atomicValue(s, ctx, func(ctx context.Context) ([]TriggerRow, error) {
