...
var presets = []Preset{
	...
	{ID: "chrome-devtools", Name: "Chrome DevTools", Description: "官方 Chrome DevTools MCP，控制本机 Chrome", Transport: "stdio", Command: "npx", Args: []string{"-y", "chrome-devtools-mcp"}, Category: "浏览器"},
	{ID: "browsermcp", Name: "Browser MCP", Description: "使用已登录的本机 Chrome（需扩展）。不是云端浏览器", Transport: "stdio", Command: "npx", Args: []string{"-y", "@agent360/browser-mcp"}, Category: "浏览器"},
