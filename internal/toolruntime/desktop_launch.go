...
var knownLaunchApps = []knownLaunchApp{
	...
	},
	{
		...
		ExeHints: []string{
			...
			`%LOCALAPPDATA%\SodaMusic\汽水音乐.exe`,
			`%LOCALAPPDATA%\Soda Music\Soda Music.exe`,
			`%LOCALAPPDATA%\Soda Music\汽水音乐.exe`,
			`%LOCALAPPDATA%\Programs\Soda Music\Soda Music.exe`,
			`%LOCALAPPDATA%\Programs\Soda Music\汽水音乐.exe`,
			`%LOCALAPPDATA%\Programs\SodaMusic\Soda Music.exe`,
			`%LOCALAPPDATA%\Programs\SodaMusic\汽水音乐.exe`,
			`%ProgramFiles%\SodaMusic\Soda Music.exe`,
			`%ProgramFiles(x86)%\SodaMusic\Soda Music.exe`,
		},
		WalkRoots: []string{
			...
			`%APPDATA%\SodaMusic`,
			`%ProgramFiles%\SodaMusic`,
			`%ProgramFiles(x86)%\SodaMusic`,
		},
	},
	{
		Canonical: "QQ音乐",
