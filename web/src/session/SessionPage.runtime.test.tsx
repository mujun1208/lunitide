...
it('auto-approves office generation in full-access instead of asking again in 任务过程',async()=>{
 ...
 await act(async()=>{
  onEvent({v:'1.0',kind:'event',id:'01ARZ3NDEKTSV4RRFFQ69G5FAG',streamId:'01ARZ3NDEKTSV4RRFFQ69G5FAD',sequence:3,type:'completed',completed:{messageId:'01ARZ3NDEKTSV4RRFFQ69G5FAH'}})
 })
 await waitFor(()=>expect(start).toHaveBeenCalledOnce())
