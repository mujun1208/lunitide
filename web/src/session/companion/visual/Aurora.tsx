// Portions from React Bits Aurora, MIT, https://github.com/DavidHDev/react-bits
import { Color, Mesh, Program, Renderer, Triangle } from 'ogl'
import { useEffect, useRef } from 'react'
import { AURORA_STOPS } from './moonVisual'
...
void main() {
  ...
  if (uLightMode > 0.5) {
    vec3 lightSky = vec3(0.97, 0.97, 0.99);
    vec3 darkened = auroraColor * auroraAlpha * 0.6;
    fragColor = vec4(max(lightSky - darkened, vec3(0.0)), 1.0);
  } else {
...
export function Aurora({
  ...
  return <div ref={ctnRef} className="companion-aurora-canvas" aria-hidden />
}
