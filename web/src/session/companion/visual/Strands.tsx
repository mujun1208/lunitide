// Portions from React Bits Strands, MIT, https://github.com/DavidHDev/react-bits
import { Color, Mesh, Program, Renderer, RenderTarget, Triangle } from 'ogl'
import { useEffect, useRef } from 'react'
import { MOON_PALETTE } from './moonVisual'
...
export function Strands({
  ...
  const propsRef = useRef({
    ...
    hueShift, intensity, saturation, opacity, scale, glass, refraction, dispersion, glassSize, active,
  })
  propsRef.current = {
    colors, count, speed, amplitude, waviness, thickness, glow, taper, spread,
    hueShift, intensity, saturation, opacity, scale, glass, refraction, dispersion, glassSize, active,
  ...
  useEffect(() => {
    ...
    gl.canvas.style.cssText = 'width:100%;height:100%;display:block;background:transparent;'
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uHueShift.value = current.hueShift + (current.glass ? t * 0.00003 : 0)
  ...
  return <div ref={ctnRef} className="companion-strands-canvas" aria-hidden />
}
