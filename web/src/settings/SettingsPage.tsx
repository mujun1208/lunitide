...
import{setVoicePrewarmEnabled,voicePrewarmEnabled}from'../session/companion/voicePrewarm'
...
export function CompanionSection():React.JSX.Element{
 ...
 const[prewarmOn,setPrewarmOn]=useState(voicePrewarmEnabled())
