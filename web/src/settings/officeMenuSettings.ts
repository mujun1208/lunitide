...
export type OfficeMenuSettings = { people: boolean; mro: boolean; office: boolean; meetings: boolean }
export const DEFAULT_OFFICE_MENU: Readonly<OfficeMenuSettings> = { people: false, mro: false, office: false, meetings: false }
...
export function loadOfficeMenu(): OfficeMenuSettings {
  try {
    ...
    if (value && typeof value === 'object') {
      ...
      return { people: saved.people === true, mro: saved.mro === true, office: saved.office === true, meetings: saved.meetings === true }
    }
