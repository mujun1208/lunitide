...
vi.mock('./bridge/client', async importOriginal => {
  ...
  return {
    ...
    getMeetingsBridge: () => ({ list: vi.fn().mockResolvedValue({ items: [] }), start: vi.fn(), append: vi.fn(), loopbackPoll: vi.fn(), stop: vi.fn(), get: vi.fn(), summarize: vi.fn(), exportMeeting: vi.fn(), update: vi.fn(), delete: vi.fn() }),
    meetingsBridge: { list: () => Promise.resolve({ items: [] }), start: vi.fn(), append: vi.fn(), loopbackPoll: vi.fn(), stop: vi.fn(), get: vi.fn(), summarize: vi.fn(), exportMeeting: vi.fn(), update: vi.fn(), delete: vi.fn() },
  }
})
