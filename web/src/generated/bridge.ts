...
export type ContextStatusResult = { "canonicalLogicalTokens": number; "estimatedRequestTokens": number; "modelContextWindow": number; "activeCheckpointVersion": number; "budgetUsage": number; "isCompacting": boolean }
