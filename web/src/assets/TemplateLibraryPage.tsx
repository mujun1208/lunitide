...
import type { TemplateCreatePayload, TemplateCreateResult, TemplateDeletePayload, TemplateDeleteResult, TemplateEnablePayload, TemplateEnableResult, TemplateListResult, TemplateRestorePayload, TemplateRestoreResult, TemplateVoidPayload, TemplateVoidResult } from '../generated/bridge'
...
export function TemplateLibraryPage({ templates = templateBridge }: { templates?: TemplateBridge }): React.JSX.Element {
  ...
  return (
    <div className="shell project-page pm-shell">
      <header className="project-hero">
        <div>
          <p className="eyebrow">ASSET TEMPLATE LIBRARY</p>
          <h1>资产库模版管理</h1>
