...
assert(JSON.stringify(enabled) === JSON.stringify([
  ...
  'browser.open',
  'capability.list',
  'capability.roles.get',
  'capability.roles.set',
  'cc.emergencyStop',
  'cc.getAuditLog',
  'cc.getConfig',
  'cc.updateConfig',
  ...
  'command.start',
  'complexity.decide',
  'connector.recipe.list',
  'connector.recipe.revoke',
  'connector.snapshot',
  ...
  'mro.chem.issue',
  'mro.component.list',
  'mro.component.upsert',
  'mro.due.list',
  'mro.due.recompute',
  'mro.due.upsert',
  'mro.interval.list',
  'mro.interval.propose',
  'mro.interval.upsert',
  'mro.kit.staging',
  'mro.kit.upsert',
  'mro.life.event',
  ...
  'mro.ops.todo.add',
  'mro.ops.todo.list',
  'mro.parts.stock.list',
  'mro.parts.stock.upsert',
  'mro.pirep.confirm',
  'mro.pirep.draft',
  'mro.pirep.list',
  'mro.plan.constraint.check',
  'mro.plan.list',
  'mro.plan.publish',
  'mro.po.confirm',
  'mro.po.draft',
  ...
  'office.artifact.export',
  'office.artifact.import',
  'office.artifact.open',
  'office.artifact.patch',
  'office.artifact.patchChart',
  'office.artifact.patchRange',
  'office.artifact.preview',
  'office.artifact.readChunk',
  'office.artifact.refresh',
  'office.artifact.replaceImage',
  'office.artifact.restore',
  'office.artifact.validate',
  'office.bundle.create',
  'office.bundle.export',
  'office.bundle.list',
  'office.metric.apply',
  'office.metric.capture',
  'office.metric.list',
  'office.renderer.probe',
  'office.storage.sweep',
  ...
  'plugin.upgrade',
  'productHub.apply',
  'productHub.auth.changePassword',
  'productHub.auth.status',
  'productHub.auth.unlock',
  'productHub.changelog',
  'productHub.diagnostics',
  'productHub.export',
  'productHub.featureCard',
  'productHub.graph',
  'productHub.node',
  'productHub.overview',
  'productHub.refresh',
  ...
  'project.db.bind',
  'project.delete',
  'project.deliverable.generate',
  'project.executor.set',
  'project.interview.get',
  'project.interview.save',
  'project.list',
  'project.publish',
  ...
  'project.root.rebind',
  'project.rules.get',
  'project.rules.materialize',
  'project.schema.get',
  'project.schema.materialize',
  'project.schema.put',
  'project.schema.verify',
  'project.task.complete',
  'project.task.open',
  'project.task.report',
  'project.task.returnFromTest',
  'project.test.run',
  'project.tree.get',
  'project.tree.materialize',
  'project.tree.put',
  'project.update',
  ...
  'provider.create',
  'provider.credential.backup.add',
  'provider.credential.backup.remove',
  ...
  'skill.package.list',
  'skill.package.read',
  'skill.package.upload.abort',
  'skill.package.upload.begin',
  'skill.package.upload.chunk',
  'skill.package.upload.commit',
  'skill.publish',
  'skill.update',
  'stage.create',
  'stage.list',
  ...
  'tts.cancel',
  'tts.ensureRefEngine',
  'tts.installOnnxEngine',
  'tts.installRefEngine',
  'tts.refAudios',
  'tts.stream',
  'tts.synthesize',
  'tts.voices',
