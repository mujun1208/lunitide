...
| R0 | 包装 | 干净树 + 批准身份签名 | 陌生机安装能连引擎：本机 2026-09-01 已从 0.4.44 升到 0.4.45。**0.4.47 包已打**（`release/out/Lunitide-Setup-0.4.47-x64.exe`），官方目录未升前不能用 0.4.45 / 0.4.46 勾本波 F-* / 会议复读 / 首页不再听。**不是**干净 Win10/Win11 双机 R0 |

---

## 语音三卡（须 0.4.47，旧 W1-VOICE / 仅 0.4.45 / 0.4.46 作废）
