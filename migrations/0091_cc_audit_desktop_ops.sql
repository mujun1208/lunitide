-- 0091 Widen cc_audit_log.tool for remaining OpenClaw-parity computer-control
-- operations (window action, app list/quit, paste, press, menu, set-value).
...
ALTER TABLE cc_audit_log RENAME TO cc_audit_log_0091_old;
...
INSERT INTO cc_audit_log SELECT * FROM cc_audit_log_0091_old;
DROP TABLE cc_audit_log_0091_old;
