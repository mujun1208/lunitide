...
CREATE INDEX ix_sessions_project_created ON sessions(project_id, created_at, id);

DROP INDEX ix_idempotency_expires;
ALTER TABLE idempotency_records RENAME TO idempotency_records_0008_old;
...
INSERT INTO idempotency_records SELECT * FROM idempotency_records_0008_old;
DROP TABLE idempotency_records_0008_old;
CREATE INDEX ix_idempotency_expires ON idempotency_records(expires_at);

DROP INDEX ix_audit_aggregate_created;
ALTER TABLE audit_events RENAME TO audit_events_0008_old;
...
INSERT INTO audit_events SELECT * FROM audit_events_0008_old;
DROP TABLE audit_events_0008_old;
