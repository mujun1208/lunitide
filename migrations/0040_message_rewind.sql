ALTER TABLE message_session_state RENAME TO message_session_state_0039_old;
...
INSERT INTO message_session_state(session_id,last_sequence,message_count,text_bytes,history_revision)
SELECT session_id,last_sequence,message_count,text_bytes,0 FROM message_session_state_0039_old;
DROP TABLE message_session_state_0039_old;

-- Add durable message rewind idempotency and audit allowlists.
DROP INDEX ix_idempotency_expires;
ALTER TABLE idempotency_records RENAME TO idempotency_records_0039_old;
...
INSERT INTO audit_events SELECT * FROM audit_events_0039_old;
DROP TABLE audit_events_0039_old;
