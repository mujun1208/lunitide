-- 0100 Widen cc_audit_log.tool so computer.act can be recorded as itself.
...
ALTER TABLE cc_audit_log RENAME TO cc_audit_log_0100_old;
...
INSERT INTO cc_audit_log SELECT * FROM cc_audit_log_0100_old;
DROP TABLE cc_audit_log_0100_old;
